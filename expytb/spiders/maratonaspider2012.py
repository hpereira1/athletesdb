...
class MaratonaSpider2012(scrapy.Spider):
	name = 'maratona2012'
	start_urls = ['https://www.worldathletics.org/competitions/olympic-games/the-xxx-olympic-games-6999193/results/men/marathon/final/result']
	...
	def parse(self, response):
		...
		for athletes in response.css('tr.TableCollapsible_row__3Rxm4'):
			...
			item['competition'] = "maratonamasc2012",
