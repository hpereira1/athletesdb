...
class WACmen19Spider(scrapy.Spider):
    name = 'WACmen19'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/iaaf-world-athletics-championships-doha-2019-7125365/results/men/shot-put/final/result']
