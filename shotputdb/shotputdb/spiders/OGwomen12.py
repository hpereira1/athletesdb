...
class OGwomen12Spider(scrapy.Spider):
    name = 'OGwomen12'
    start_urls = ['https://worldathletics.org/competitions/olympic-games/the-xxx-olympic-games-6999193/results/women/shot-put/final/result']
