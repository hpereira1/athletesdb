...
class WACwomen17Spider(scrapy.Spider):
    name = 'WACwomen17'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/iaaf-world-championships-london-2017-7093740/results/women/shot-put/final/result']
