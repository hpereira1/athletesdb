...
class WACmen13Spider(scrapy.Spider):
    name = 'WACmen13'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/14th-iaaf-world-championships-7003368/results/men/shot-put/final/result']
