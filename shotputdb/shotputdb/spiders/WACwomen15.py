...
class WACwomen15Spider(scrapy.Spider):
    name = 'WACwomen15'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/15th-iaaf-world-championships-7078726/results/women/shot-put/final/result']
    ...
    def parse(self, response):
        for athletes in response.css('tr.TableCollapsible_row__3Rxm4'):
            ...
            item['competition'] = "	15th IAAF World Championships",    
