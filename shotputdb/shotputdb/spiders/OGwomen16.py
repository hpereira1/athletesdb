...
class OGwomen16Spider(scrapy.Spider):
    name = 'OGwomen16'
    start_urls = ['https://worldathletics.org/competitions/olympic-games/the-xxxi-olympic-games-7093747/results/women/shot-put/final/result']
