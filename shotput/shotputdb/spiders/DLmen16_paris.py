...
class DLmenSpider16_paris(scrapy.Spider):
    name = 'dlmen16_paris'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7093350/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Paris Meeting - 27 AUG 2016",
