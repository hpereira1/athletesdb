...
class WACwomen19Spider(scrapy.Spider):
    name = 'WACwomen19'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/iaaf-world-athletics-championships-doha-2019-7125365/results/women/shot-put/final/result']
