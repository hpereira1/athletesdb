...
class DLmenSpider19_bruxelles(scrapy.Spider):
    name = 'dlmen19_bruxelles'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7135126/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "AG Memorial Van Damme - 05–06 SEP 2019",
