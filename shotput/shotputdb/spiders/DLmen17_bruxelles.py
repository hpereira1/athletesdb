...
class DLmenSpider17_bruxelles(scrapy.Spider):
    name = 'dlmen17_bruxelles'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7104903/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Bruxelles Memorial Van Damme - 31 AUG–01 SEP 2017",
