...
class DLmenSpider18(scrapy.Spider):
    name = 'dlmen18_eugene'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7118679/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Eugene Prefontaine Classic - 25–26 MAY 2018",
            item['sport'] = "Shot Put",
            item['gender'] = "M"
            yield item
            N+=1