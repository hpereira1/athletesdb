...
class WAICwomen16Spider(scrapy.Spider):
    name = 'WAICwomen16'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-indoor-championships/iaaf-world-indoor-championships-7093741/results/women/shot-put/final/result']
    ...
    def parse(self, response):
        for athletes in response.css('tr.TableCollapsible_row__3Rxm4'):
            ...
            item['competition'] = "	IAAF World Indoor Championships 2016",    
