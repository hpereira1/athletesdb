...
class DLWomenSpider16(scrapy.Spider):
    name = 'dlwomen16'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7093323/result?eventId=10229530&gender=W']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Doha IAAF Diamond League - 06 MAY 2016",
            item['sport'] = "Shot Put",
            item['gender'] = "F"
            yield item
            N+=1