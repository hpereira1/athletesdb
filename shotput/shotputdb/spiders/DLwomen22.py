...
class DLWomenSpider19(scrapy.Spider):
    name = 'dlwomen19'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7130737/result?eventId=10229530&gender=W']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "IAAF Diamond League - 18 MAY 2019",
            item['sport'] = "Shot Put",
            item['gender'] = "F"
            yield item
            N+=1