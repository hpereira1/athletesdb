...
class DLmenSpider16_shanghai(scrapy.Spider):
    name = 'dlmen16_shanghai'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7093324/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Shanghai Golden Grand Prix - 14 MAY 2016",
