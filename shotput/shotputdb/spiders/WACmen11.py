...
class WACmen11Spider(scrapy.Spider):
    name = 'WACmen11'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/13th-iaaf-world-championships-in-athletics-7003367/results/men/shot-put/final/result']
