...
class DLWomenSpider15_paris(scrapy.Spider):
    name = 'dlwomen15_paris'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7078655/result?eventId=10229530&gender=W']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Paris Meeting AREVA - 04 JUL 2015",
            item['sport'] = "Shot Put",
            item['gender'] = "F"
            yield item
            N+=1