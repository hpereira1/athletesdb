...
class DLMenSpider15(scrapy.Spider):
    name = 'dlmen15'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7078661/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Doha IAAF Diamond League - 15 MAY 2015",
