...
class OGmen16Spider(scrapy.Spider):
    name = 'OGmen16'
    start_urls = ['https://worldathletics.org/competitions/olympic-games/the-xxxi-olympic-games-7093747/results/men/shot-put/final/result']
