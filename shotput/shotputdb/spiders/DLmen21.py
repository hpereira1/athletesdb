...
class DLMenSpider21(scrapy.Spider):
    name = 'dlmen21'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7147584/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Diamond League Meeting - 28 MAY 2021",
            item['sport'] = "Shot Put",
            item['gender'] = "M"
            yield item
            N+=1