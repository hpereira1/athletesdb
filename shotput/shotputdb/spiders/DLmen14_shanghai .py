...
class DLmenSpider14_shanghai(scrapy.Spider):
    name = 'dlmen14_shanghai'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7065890/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Shanghai Golden Grand Prix - 18 MAY 2014",
