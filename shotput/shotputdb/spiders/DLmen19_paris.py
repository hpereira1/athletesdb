...
class DLmenSpider19_paris(scrapy.Spider):
    name = 'dlmen19_paris'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7134796/result?eventId=10229619&gender=M']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Meeting de Paris - 24 AUG 2019",
            item['sport'] = "Shot Put",
            item['gender'] = "M"
            yield item
            N+=1