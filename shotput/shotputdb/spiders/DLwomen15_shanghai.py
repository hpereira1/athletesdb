...
class DLwomenSpider15_shanghai(scrapy.Spider):
    name = 'dlwomen15_shanghai'
    start_urls = ['https://www.worldathletics.org/competitions/diamond-league/calendar-results/7078665/result?eventId=10229530&gender=W']
    ...
    def parse(self, response):
        ...
        for athletes in response.css('table.styles_table__yjrQa > tbody > tr'):
            ...
            item['competition'] = "Shanghai Golden Grand Prix - 17 MAY 2015",
