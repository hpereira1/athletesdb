...
class MaratonaFemSpider2020(scrapy.Spider):
	name = 'maratonafem2020'
	start_urls = ['https://www.worldathletics.org/competitions/olympic-games/the-xxxii-olympic-games-athletics-7132391/results/women/marathon/final/result']
	...
	def parse(self, response):
		...
		for athletes in response.css('tr.TableCollapsible_row__3Rxm4'):
			...
			item['competition'] = "maratonafem2020",
