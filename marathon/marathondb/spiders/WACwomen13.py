...
class WACwomen13Spider(scrapy.Spider):
    name = 'WACwomen13'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/14th-iaaf-world-championships-7003368/results/women/marathon/final/result']
