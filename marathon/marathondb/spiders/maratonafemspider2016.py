...
class MaratonaFemSpider2016(scrapy.Spider):
	name = 'maratonafem2016'
	start_urls = ['https://www.worldathletics.org/competitions/olympic-games/the-xxxi-olympic-games-7093747/results/women/marathon/final/result']
	...
	def parse(self, response):
		...
		for athletes in response.css('tr.TableCollapsible_row__3Rxm4'):
			...
			item['competition'] = "The XXXI Olympic Games",
