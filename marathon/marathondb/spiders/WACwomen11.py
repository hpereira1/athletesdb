...
class WACwomen11Spider(scrapy.Spider):
    name = 'WACwomen11'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/13th-iaaf-world-championships-in-athletics-7003367/results/women/marathon/final/result']
