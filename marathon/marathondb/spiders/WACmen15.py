...
class WACmen15Spider(scrapy.Spider):
    name = 'WACmen15'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/15th-iaaf-world-championships-7078726/results/men/marathon/final/result']
