...
class WACmen22Spider(scrapy.Spider):
    name = 'WACmen22'
    start_urls = ['https://worldathletics.org/competitions/world-athletics-championships/world-athletics-championships-oregon-2022-7137279/results/men/marathon/final/result']
